...
import 'package:ranro_mob/screens/printing.dart';
import '../screens/home.dart';

class LoanDetailsQR extends StatefulWidget {
  final String id;
  final String totalAmount;
  final String installmentAmount;
  final String due_amount;

  const LoanDetailsQR(this.id, this.totalAmount, this.installmentAmount,this.due_amount,
      {Key? key})
      : super(key: key);

  @override
  State<LoanDetailsQR> createState() => _LoanDetailsQRState();
}

class _LoanDetailsQRState extends State<LoanDetailsQR> {
            ...
            actions: <Widget>[
              TextButton(
                ...
                onPressed: () {
                  ...
                  MaterialPageRoute(builder: (context) => Printing(widget.totalAmount,_installmentAmountController.text,widget.due_amount,widget.id)),
                  );
                },
              ),
            ],
