...
import 'loans_list_with_due_ammount.dart';
          ...
          Expanded(
            ...
            child: FittedBox(
              ...
              child: Column(
                ...
                children: <Widget>[
                  if (result != null)
                    ////////////////////////////////////////////if qr not null redirect to user
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: IconButton(onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LoandList_due()),
                          );
    ...
    controller.scannedDataStream.listen((scanData) {
      setState(() {
        ...
        if (result != null && !_isNavigated){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => LoansList_qr(data:value)),
          );
        }
